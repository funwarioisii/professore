...
[実音声付きサンプルMP4（2分13秒）](../examples/output/video.mp4) · [検証結果](verification.md)
...
[設計・採用理由](design.md)、[検証結果と制約](verification.md) を参照してください。外部URLに依存せずレンダリングし、ローカルサービスは127.0.0.1でのみ待ち受け、Host/Originを検証します。
